      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <Link href="/" className="text-[#a0a0a8] hover:text-white font-medium transition-colors duration-300 relative group">
              Home
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#466384] group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link href="/about" className="text-[#a0a0a8] hover:text-white font-medium transition-colors duration-300 relative group">
              About Us
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#466384] group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link href="/services" className="text-[#a0a0a8] hover:text-white font-medium transition-colors duration-300 relative group">
              Services
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#466384] group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link href="/downloads" className="text-[#a0a0a8] hover:text-white font-medium transition-colors duration-300 relative group">
              Downloads
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#466384] group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link href="/reviews" className="text-[#a0a0a8] hover:text-white font-medium transition-colors duration-300 relative group">
              Reviews
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#466384] group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link href="/contact" className="text-[#a0a0a8] hover:text-white font-medium transition-colors duration-300 relative group">
              Contact Us
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#466384] group-hover:w-full transition-all duration-300"></span>
            </Link>
          </nav>

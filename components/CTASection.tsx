        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="opacity-90">Warranty on All Repairs</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="opacity-90">Repair Available</div>
            </div>
          </div>
        </div>
      </div>
